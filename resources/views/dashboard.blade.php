    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Top 10 Total Progress Tertinggi ({{ $ketUploadTerakhir }})</h6>
            </div>
                ...
                <div class="col-4">
                    <div class="card shadow podium podium-2 bg-secondary text-white">
                        <div class="card-body">
                            <i class="fas fa-medal fa-2x mb-2"></i>
                            <h5>{{ $top10[1]->nama }}</h5>
                            <h3>{{ number_format($top10[1]->total_progress) }}</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-4">
                    <div class="card shadow-lg podium podium-1 bg-warning text-white">
                        <div class="card-body">
                            ...
                            <h4>{{ $top10[0]->nama }}</h4>
                            <h2>{{ number_format($top10[0]->total_progress) }}</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-4">
                    <div class="card shadow podium podium-3 bg-info text-white">
                        <div class="card-body">
                            ...
                            <h5>{{ $top10[2]->nama }}</h5>
                            <h3>{{ number_format($top10[2]->total_progress) }}</h3>
                        </div>
                    </div>
                </div>
            ...
            @php
                $max = $top10->max('total_progress');
            @endphp

            {{-- Ranking 4-10 --}}
            @foreach($top10->slice(3) as $p)
