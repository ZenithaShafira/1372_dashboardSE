    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="container">
                ...
                <div class="row mb-3">
                    <small class="text-muted" id="keteranganPerhitungan">
                        Perhitungan: Upload
                        {{ \Carbon\Carbon::parse($uploadSebelumnya)->translatedFormat('d F Y') }}
                        →
                        {{ \Carbon\Carbon::parse($uploadTerakhir)->translatedFormat('d F Y') }}
                    </small>
                </div>
            </div>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        progressChart = new Chart(ctxProgress, {
            ...
            data: {
                ...
                datasets: [
                    {
                        // label: 'Jumlah Assignment Selain OPEN, DRAFT, dan SUBMITTED RESPONDENT',
            ...
            options: {
                ...
                scales: {
                    ...
                    y: {
                        beginAtZero: true,
                        suggestedMax: Math.max(...chartData.progress) + 2,
                        ticks: {
                            precision: 0
                        },
                        grid: {
